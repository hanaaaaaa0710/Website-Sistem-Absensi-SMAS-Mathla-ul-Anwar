...
<body>
    ...
    <div class="judul-laporan"><h2>Laporan Absensi Harian</h2></div>
    ...
    <table class="informasi-laporan">
        ...
        <tr>
            <td>Status</td><td>: {{ $statusDipilih }}</td>
            <td>Siswa</td><td>: {{ $namaSiswa }}</td>
        </tr>
    </table>
    ...
    <table class="tabel-laporan">
        <thead>
            <tr>
                ...
                <th style="width:8%">Kelas</th><th style="width:10%">Status</th><th style="width:11%">Jam Masuk</th>
                <th style="width:14%">Keterangan</th><th style="width:14%">Catatan</th><th style="width:10%">Nilai Disiplin</th>
            </tr>
        </thead>
        <tbody>
            ...
            @empty
                <tr><td colspan="9" style="text-align:center">Belum ada data absensi.</td></tr>
            @endforelse
        </tbody>
    </table>
    ...
    <table class="tanda-tangan">
        <tr>
            ...
            <td>
                Karawang, {{ now()->format('d-m-Y') }}<br>Wali Kelas
                <div class="ruang-tanda-tangan"></div>
                <div class="nama-penanda-tangan">........................................</div>
                <div>NIP. ................................</div>
            </td>
